package com.djd2000.springbatch.patientbatchloader.domain;
...
public class PatientRecord implements Serializable {
	...
	public String toString() {
		return "PatientRecord [sourceId=" + sourceId + ", firstName=" + firstName + ", middleInitial=" + middleInitial
				+ ", lastName=" + lastName + ", emailAddress=" + emailAddress + ", phoneNumber=" + phoneNumber
				+ ", street=" + street + ", city=" + city + ", state=" + state + ", zip=" + zip + ", birthDate="
				+ birthDate + ", action=" + action + ", ssn=" + ssn + "]";
	}
}
